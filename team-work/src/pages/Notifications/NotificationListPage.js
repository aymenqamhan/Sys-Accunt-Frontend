...
// // Assuming you have icons, if not, standard text or react-icons can be used
// import { FaTrash, FaCheck, FaCheckDouble, FaPlus } from 'react-icons/fa';
...
//             // Adjust based on actual API response structure (e.g., response.data or response.data.results)
...
//                             className="bg-blue-100 text-blue-600 px-4 py-2 rounded hover:bg-blue-200 transition"
//                         >
//                             <FaCheckDouble className="inline mr-2" /> Mark All Read
//                         </button>
//                         <Link
//                             to="/notifications/new"
//                             className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 transition"
//                         >
//                             <FaPlus className="inline mr-2" /> New Notification
//                         </Link>
//                     </div>
//                 </div>
...
//                                     className={`p-4 flex justify-between items-start transition ${notification.is_read ? 'bg-white' : 'bg-blue-50'}`}
//                                 >
//                                     <div className="flex-1">
//                                         <div className="flex items-center mb-1">
//                                             <h3 className={`font-semibold text-lg ${notification.is_read ? 'text-gray-700' : 'text-blue-800'}`}>
//                                                 {notification.title}
//                                             </h3>
//                                             {!notification.is_read && (
//                                                 <span className="ml-2 bg-blue-500 text-white text-xs px-2 py-0.5 rounded-full">New</span>
//                                             )}
...
//                                             <span className="bg-gray-100 px-2 py-1 rounded">Type: {notification.notification_type}</span>
//                                             {notification.user_id !== 0 && <span>User ID: {notification.user_id}</span>}
//                                         </div>
//                                     </div>
...
// const NotificationListPage = () => {
//     // نبدأ بمصفوفة فارغة لتجنب أخطاء الـ map في البداية
//     const [notifications, setNotifications] = useState([]);
//     const [loading, setLoading] = useState(true);
//     const [error, setError] = useState(null);
...
//             console.log("Response Data:", response.data); // للتأكد في الكونسول

//             // التعديل: التحقق من شكل البيانات (هل هي مصفوفة مباشرة أم داخل results)
//             if (Array.isArray(response.data)) {
//                 setNotifications(response.data);
//             } else if (response.data && Array.isArray(response.data.results)) {
//                 // هذا خاص بـ Django Rest Framework Pagination
//                 setNotifications(response.data.results);
//             } else {
//                 // إذا لم تكن البيانات مصفوفة، نضع مصفوفة فارغة
//                 setNotifications([]);
//             }
...
//             setError('Failed to load notifications.');
//             console.error(err);
//             setNotifications([]); // في حالة الخطأ نصفر المصفوفة
//         } finally {
//             setLoading(false);
//         }
//     };
...
//                 <div className="bg-white shadow rounded-lg overflow-hidden">
//                     {/* حماية إضافية: التحقق من أن notifications عبارة عن مصفوفة ولديها عناصر */}
