...
المشروع مبني باستخدام **React** بهيكلية ملفات قياسية تساعد على التنظيم، سهولة الصيانة، وقابلية التوسع.
...
📖 شرح المجلدات
public/
يحتوي على الأصول الثابتة مثل index.html وملفات PWA (manifest, icons).
...
3. تشغيل الخادم المحلي للــ backend
...
4 . لشغيل سرفر react باستخدام termenal اخر :
